...
% enter the data.
x = [2051.32560426 2148.61893727 2224.19251998 2295.23183355 2348.76568045 2398.4887764]; %the indep.
%which we convert from Gauss to Tesla
x=x/10000;
alpha1=0.607; %angle of unshifted spectral line (degrees)
%convert to radians
alpha1=alpha1*pi/180;
%the next line is the angle of one of the shifted lines corresponding to
%the various magnetic fields
alpha = [0.676 0.681 0.692 0.703 0.703 0.708];
%the angle
%convert to radians
alpha=alpha*pi/180;
